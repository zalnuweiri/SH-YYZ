...
export const T = {
  hero:     "font-display text-[round(4.6875vw,1px)] tracking-[0.1em]",  // Desktop/Hero — Monoglyphic 60
  h1:       "font-display text-[round(3.125vw,1px)] tracking-[0.1em]",   // Desktop/H1   — Monoglyphic 40 (caller adds uppercase)
  h2:       "font-display text-[round(2.1875vw,1px)] tracking-[0.02em]", // Desktop/H2   — Monoglyphic 28
  h3:       "font-display text-[round(1.71875vw,1px)] tracking-[0.15em]",// Desktop/H3   — Monoglyphic 22
  subtitle: "font-body text-[round(1.71875vw,1px)] tracking-[0.2em]",    // Desktop/Subtitle — NeueBit 22, ls 20%
  body:     "font-body text-[round(1.71875vw,1px)] tracking-[0.1em]",    // Desktop/Body — NeueBit 22, ls 10%
  caption:  "font-body text-[round(1.25vw,1px)] tracking-[0.2em]",       // Caption 1 — NeueBit 16, ls 20% (caller adds uppercase)
  button:   "font-body text-[round(1.25vw,1px)] tracking-[0.1em]",       // Button   — NeueBit 16, ls 10% (caller adds uppercase)
  caption2: "font-body text-[round(1.09375vw,1px)] tracking-[0.2em]",    // Caption 2 — NeueBit 14, ls 20%
};
...
/**
 * Outlined "Secondary" button base — cream border + 16px uppercase label that fades
 * cream→pink on hover (the Figma SecondaryButton hover delta is the text colour only).
 * Width/height are added per use (e.g. "w-[16.875vw] h-[3.75vw]").
 */
export const BTN_OUTLINE =
  `inline-flex items-center justify-center rounded-[4px] border border-sh-cream ` +
  `font-body uppercase text-sh-cream text-[round(1.25vw,1px)] tracking-[0.13vw] ` +
  `${EASE} hover:text-sh-pink`;
