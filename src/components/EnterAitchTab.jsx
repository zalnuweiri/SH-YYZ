...
export default function EnterAitchTab() {
    return (
        <a
            ...
            className="hidden md:block fixed right-[2vw] top-[40vh] -translate-y-1/2 z-40 transition-transform duration-300 hover:-translate-x-1 drop-shadow-lg"
        >
            <img
                src="/redesign/enter-aitch-tab.png"
                alt="Enter Aitch"
                className="h-[12.5vw] w-auto select-none"
                draggable="false"
            />
        </a>
    );
